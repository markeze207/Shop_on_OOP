                    ...
                    <div class="left-sidebar">
                        ...
                        <div class="price-range"><!--price-range-->
                            ...
                            <div class="well text-center">
                                ...
                                <b class="pull-left">$ <?=$prices['minPrice']?></b> <b class="pull-right">$ <?=$prices['maxPrice']?></b>
                            </div>
                        </div><!--/price-range-->
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <a href="/products/<?=$product['ID']?>" class="btn btn-default"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        </div>
